    ...
    return (
        <div className='relative w-full h-screen overflow-hidden'>
            ...
            <div className={isMobile ? 'absolute top-[33%] left-[5%]' : 'absolute top-[54%] left-[8%]'}>
                ...
                <div>
                    <button className='font-quicksand border-2 rounded-2xl text-lg font-medium mt-5 w-36 h-9 flex items-center justify-center gap-2 cursor-pointer transition-transform hover:scale-105'>
            ...
            {!isMobile && (
                <div>
                    ...
                    <div className='absolute border-2 rounded-2xl bottom-[5%] right-[11.5%] bg-transparent w-80 h-10'>
                        <p className='font-quicksand text-lg font-medium flex justify-center items-center w-full h-full cursor-pointer transition-transform hover:scale-105'>
